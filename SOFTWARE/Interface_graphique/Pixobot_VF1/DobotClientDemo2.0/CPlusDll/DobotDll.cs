...
namespace DobotClientDemo.CPlusDll
{
    ...
    public class DobotDll
    {
        ...
        public static extern int SetEMotor(ref tagEMotor eMotor, bool isQueued, ref UInt64 queuedCmdIndex);

        [DllImport("DobotDll.dll", EntryPoint = "SetEMotorS", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetEMotorS(ref tagEMotorS eMotorS, bool isQueued, ref UInt64 queuedCmdIndex);

        [DllImport("DobotDll.dll", EntryPoint = "GetJOGLParams", CallingConvention = CallingConvention.Cdecl)]
        public static extern int GetJOGLParams(ref JOGLParams jogLParams);

        [DllImport("DobotDll.dll", EntryPoint = "SetAutoLevelingCmd", CallingConvention = CallingConvention.Cdecl)]
        public static extern int SetAutoLevelingCmd(ref tagAutoLevelingCmd autoLeveling, bool isQueud, ref UInt64 queuedCmdIndex);
